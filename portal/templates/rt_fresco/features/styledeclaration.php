<?php
/**
* @version   $Id: styledeclaration.php 883 2012-05-28 20:11:32Z kevin $
...
function init() {
    ...
    $css = $this->buildLogo();
        ...
        $gantry->addStyle($gantry->get('mainstyle').'.css');
        $gantry->addStyle($gantry->get('mainstyle').'-extensions.css');
