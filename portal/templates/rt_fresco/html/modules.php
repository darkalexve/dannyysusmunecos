<?php
/**
* @version   $Id: modules.php 865 2012-05-28 03:33:08Z kevin $
	        ...
	        <?php endif; ?>
	            <div class="rt-block">
	            	<div class="module-surround">
	            		<?php if ($gantry->get('menu-splitmenu-sidemenu-title')): ?>
        ...
        <?php endif; ?>
            <div class="rt-block">
            	<div class="module-surround">
            		...
            		<?php $backgroundimage = str_replace("'", '"', $params->get('backgroundimage'));
					if (json_decode($backgroundimage)){
						$backgroundimage = json_decode($backgroundimage);
						$backgroundimage = $backgroundimage->path;
					} ?>
					<div class="custom-header" style="background-image:url(<?php echo $backgroundimage; ?>)">
            		<?php endif; ?>
